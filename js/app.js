(() => {
    ...
    function initSliders() {
        if (document.querySelector(".home-slider__slider") && document.documentElement.clientWidth < 992) new swiper_core_Swiper(".home-slider__slider", {
            ...
            pagination: {
                el: ".full-page-home__labels",
                clickable: true
            },
            on: {
                init: function() {
                    if (document.querySelector(".titles-home-slides__title")) {
                        const names = document.querySelectorAll(".titles-home-slides__title");
                        const bullets = document.querySelectorAll(".full-page-home__labels .swiper-pagination-bullet");
        ...
        if (document.querySelector(".partners-home__slider")) new swiper_core_Swiper(".partners-home__slider", {
            ...
            navigation: {
                prevEl: ".partners-home__button--prev",
                nextEl: ".partners-home__button--next"
            },
            breakpoints: {
                0: {
                    slidesPerView: 3,
        ...
        if (document.querySelector(".images-product__slider") && document.querySelectorAll(".images-product__slide").length > 3) new swiper_core_Swiper(".images-product__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".images-product__button--prev",
                nextEl: ".images-product__button--next"
            },
            breakpoints: {
                0: {
                    slidesPerView: 1
            ...
            on: {}
        }); else if (document.querySelector(".images-product__buttons")) document.querySelector(".images-product__buttons").style = "display: none";
        if (document.querySelector(".colors-body-product__slider")) new swiper_core_Swiper(".colors-body-product__slider", {
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            spaceBetween: 6,
...
***************************************************************************** */
    ...
    function catalogViews() {
        if (document.querySelector(".body-catalog__view") && document.querySelector(".body-catalog")) {
            const buttons = document.querySelectorAll(".body-catalog__view");
            const wrapper = document.querySelector(".body-catalog");
            buttons.forEach((button => {
                button.addEventListener("click", (e => {
                    buttons.forEach((button => button.classList.contains("_active") ? button.classList.remove("_active") : button));
                    button.classList.contains("body-catalog__view--double") ? wrapper.classList.add("_double-card") : wrapper.classList.remove("_double-card");
